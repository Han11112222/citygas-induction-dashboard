...
def load_sales_data():
    ...
    [핵심 수정] 판매량 데이터 로드
    1. '실적_부피' 시트 사용
    2. [단위 유지] 엑셀 데이터 원본 사용 (단위: 천m³) -> *1000 제거함
    """
...
if selected_menu == "1. 전환 추세 및 상세 분석":
    ...
    # 3. 손실량 계산 & 단위 변환 (m³ -> 천m³)
    # [핵심] 인덕션 수 * PPH(m³) = m³. 이를 천m³로 변환하기 위해 / 1000
    ...
    with c6:
        ...
        fig_r2.update_layout(
            title=f"[{sel_region}] 손실 추정량 vs 가정용 판매량 (단위: 천m³)", 
