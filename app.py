...
# =========================================================
# [MENU 1] Ver 1.0 (형님 기존 코드 복구 - 수정 없음)
# =========================================================
...
# =========================================================
elif selected_menu == "2. Ver 2.0 분석 (12월 기준)":
    
    st.info("💡 **Ver 2.0 분석:** \n\n1. **세대수(Stock):** 매년 **'12월 데이터(기말)'**만 사용하여 누적 합산(12배 뻥튀기)을 방지했습니다. \n2. **사용량/손실량(Flow):** 1년간의 흐름이므로 **'1~12월 전체 합계'**를 그대로 사용합니다.")
    ...
    # 3. 판매량/손실량 데이터 (Flow Data: 연간 전체 합산 사용)
    # 손실량 (전체 월 합계 사용)
    df['월별손실추정'] = df['인덕션_추정_수'] * input_pph
    ...
    # ----------------------------------------------------
    # Ver 2.0 그래프 2 & 3: 판매량 비교 (이중축 적용 - Ver 1.0과 동일한 레이아웃 유지)
    # ----------------------------------------------------
    col1, col2 = st.columns(2)
...
# =========================================================
elif selected_menu == "3. 판매량 영향 분석":
...
elif selected_menu == "4. 지역별 위험도 순위":
...
elif selected_menu == "5. 주택 유형별 비교":
